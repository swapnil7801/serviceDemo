...
interface IServerResponse {
 ...
 @Component({
  selector: 'app-product-with-driver',
  templateUrl: './product-with-driver.component.html',
  styleUrls: ['./product-with-driver.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ProductWithDriverComponent implements OnInit {

  constructor(private _httpService: ReportServiceService) { }
    reportType='PRODUCTWITHDRIVERS';
