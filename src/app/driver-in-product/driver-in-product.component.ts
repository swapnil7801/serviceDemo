...
@Component({
  selector: 'app-driver-in-product',
  templateUrl: './driver-in-product.component.html',
  styleUrls: ['./driver-in-product.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class DriverInProductComponent implements OnInit {
  constructor(private _httpService: ReportServiceService) { }
    reportType='DRIVERSINPRODUCT';
